...
[let
 :> stack-lines
 ! change this to [a,b) for example for some reason
...
! same as move-crates, but doesn't reverse the crates
:: move-crates2 ( stack move -- stack )
    [let
     ! parse move
     move first :> crates-n
     move second 1 - :> from-idx
